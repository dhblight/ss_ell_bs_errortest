...
% spheres -> big ellipsoids -> big spheres. Concentrations are the solutions 
% to the bateman equation and are given by c_t_3species.m
%
...
numtrials = 20000; %number of times we add noise and calculate the dmd 
...
for ii = 1:n
    for jj = 1:m
        ...
        % concentrations
        [Css,Cell,Cbs] = c_t_3species(c0,T(ii,jj),tau1,tau2,nsph);
...
%     semilogy(diag(S)); % put breakpoint
    ...
    [w,e,b,final_error,evals] = multioptdmd3(X,t,r,0.032);
